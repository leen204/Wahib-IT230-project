/* ==== Wahib Clean Footer (Minimal Elegant Version - No Icons) ==== */
function buildFooter() {
  ...
  const role = (localStorage.getItem('wahib_role') || '').toLowerCase();
  const links =
    role === 'donor'
      ? [
          { href: 'donor_home.html', label: 'Home' },
          { href: 'eligibility.html', label: 'Eligibility' },
          { href: 'book_appointment.html', label: 'Book' },
          { href: 'profile.html', label: 'Profile' },
        ]
      : role === 'hospital'
      ? [
          { href: 'hospital_dashboard.html', label: 'Dashboard' },
          { href: 'add_request.html', label: 'Add Request' },
          { href: 'hospital_profile.html', label: 'Profile' },
        ]
      : [
